...
export default function Booker() {
  ...
  const selectedDates = isValid? `${firstDate} - ${secondDate}`: t("no-dates");
  ...
  return (
    <div className="booker-container bg-khaki px-4 py-10 md:px-16" id='booker'>
      <h1 className="mb-2 text-3xl font-bold text-black">{t("book-your-spot")}</h1>
      <p className='text-my-white'>{t("secure-simple-fast")}</p>
      <div className="container max-w-screen-lg">
        ...
        <div className="mt-5 grid grid-cols-2 gap-2 py-2 md:grid-cols-6 md:px-5">
          <div className="col-span-2 md:col-span-2">
            <p className="text-xl font-semibold text-black">{t("selected-dates")}</p>
            <p className="font-semibold text-my-white ">{selectedDates}</p>
          </div>
          <div>
            <div>
              <p className="text-xl font-semibold text-black">{t("check-in")}</p>
              <p className="font-semibold text-my-white">16:00</p>
            </div>
          </div>
          <div>
            <div>
              <p className="text-xl font-semibold text-black">{t("check-out")}</p>
              <p className="font-semibold text-my-white">10:00</p>
            </div>
          </div>
          <div className="">
            <p className="text-xl font-semibold text-black">{t("price")}</p>
