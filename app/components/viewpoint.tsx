...
export default function Viewpoint({image_names}: {image_names: string[]}) {

    return (
        <div className="viewpoint bg-khaki h-[950px] px-16 py-10">
            <h2 className="text-3xl font-semibold text-black">Villa viewpoint</h2>
            <div className="gallery-container bg-white flex items-center justify-center h-[720px] w-[1250px] mt-10 py-5 px-10">
              <div className="text-my-white w-full bg-white gap-4">
                <Gallery image_names={image_names} />
                </div>
            </div>
