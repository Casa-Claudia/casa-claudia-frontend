export default function BookBar(){
    return (
    <div className="w-[864px] h-[80px] relative  flex items-center bg-my-white text-my-grey z-10">
        ...
        <div className="flex items-start justify-center bg-my-white px-0.5 py-2 w-1/4">
            ...
            <div className="flex flex-col justify-start">
                <button className="mb-0.5 transform hover:scale-105 font-semibold">Check In</button>
        ...
        <div className="flex items-start justify-center bg-my-white px-0.5 py-2 w-1/4">
            ...
            <div className="flex flex-col items-left justify-center">
                <button className="mb-0.5 transform hover:scale-105 font-semibold">Check Out</button>
        ...
        <div className="flex items-center h-full justify-center w-1/4 px-0.5 py-2  bg-my-grey">
            <button className="mb-0.5 text-my-white text-lg hover:font-semibold transform hover:scale-105">Book Now</button>
        </div>
